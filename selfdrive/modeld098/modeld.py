...
PROCESS_NAME = "selfdrive.modeld098.modeld"
# backend must match how the pkls were compiled (see selfdrive/modeld/SConscript tg_devices)
os.environ['DEV'] = get_tg_input_devices(PROCESS_NAME, usbgpu=False)['DEV']

from openpilot.system.hardware import TICI
from tinygrad.tensor import Tensor
from tinygrad.dtype import dtypes
if TICI:
  from openpilot.selfdrive.modeld098.runners.tinygrad_helpers import qcom_tensor_from_opencl_address
import time
import pickle
import numpy as np
...
from openpilot.selfdrive.modeld098.parse_model_outputs import Parser
from openpilot.selfdrive.modeld098.fill_model_msg import fill_model_msg, fill_pose_msg, PublishState
from openpilot.selfdrive.modeld098.constants import ModelConstants, Plan
from openpilot.selfdrive.modeld098.models.commonmodel_pyx import DrivingModelFrame, CLContext
...
def main(demo=False):
  ...
  while True:
    ...
    if model_output is not None:
      ...
      lat_action_t = steer_delay + frame_delay + action_delay
