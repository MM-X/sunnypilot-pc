...
PROCESS_NAME = "selfdrive.modeld098.dmonitoringmodeld"
# backend must match how the pkl was compiled (see selfdrive/modeld/SConscript tg_devices)
...
from openpilot.selfdrive.modeld098.models.commonmodel_pyx import CLContext, MonitoringModelFrame
from openpilot.selfdrive.modeld098.parse_model_outputs import sigmoid
