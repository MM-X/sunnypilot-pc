...
#else
R"UI2(      font-size: 48px;)UI2"
#endif
R"UI3(      color: white;
    }
    QFrame {)UI3"
#ifdef RK_BUILD
R"UI4(      border-radius: 11px;)UI4"
#else
R"UI5(      border-radius: 30px;)UI5"
#endif
R"UI6(      background-color: #393939;
    }
    QPushButton {
      color: black;)UI6"
#ifdef RK_BUILD
R"UI7(      font-weight: 185;
      border-radius: 11px;)UI7"
#else
R"UI8(      font-weight: 500;
      border-radius: 30px;)UI8"
#endif
R"UI9(      background-color: white;
    }
  )UI9");
}
