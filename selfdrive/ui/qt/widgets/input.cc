...
#endif
  cancel_btn->setStyleSheet(R"UI4(
    QPushButton {)UI4"
#ifdef RK_BUILD
R"UI5(      font-size: 18px;
      border-radius: 4px;)UI5"
#else
R"UI6(      font-size: 48px;
      border-radius: 10px;)UI6"
#endif
R"UI7(      color: #E4E4E4;
      background-color: #333333;
    }
  ...
  textbox_widget->setStyleSheet(R"UI8(
    #textbox {)UI8"
#ifdef RK_BUILD
R"UI9(      margin-left: 18px;
      margin-right: 18px;)UI9"
#else
R"UI10(      margin-left: 50px;
      margin-right: 50px;)UI10"
#endif
R"UI11(      border-radius: 0;)UI11"
#ifdef RK_BUILD
R"UI12(      border-bottom: 1px solid #BDBDBD;)UI12"
#else
R"UI13(      border-bottom: 3px solid #BDBDBD;)UI13"
#endif
R"UI14(    }
    * {
      border: none;)UI14"
#ifdef RK_BUILD
R"UI15(      font-size: 30px;)UI15"
#else
R"UI16(      font-size: 80px;)UI16"
#endif
R"UI17(      font-weight: light;
...
#endif
  listWidget->setStyleSheet(R"UI18(
    QPushButton {)UI18"
#ifdef RK_BUILD
R"UI19(      height: 50;
      padding: 0px 18px;)UI19"
#else
R"UI20(      height: 135;
      padding: 0px 50px;)UI20"
#endif
R"UI21(      text-align: left;)UI21"
#ifdef RK_BUILD
R"UI22(      font-size: 20px;
      font-weight: 111;
      border-radius: 4px;)UI22"
#else
R"UI23(      font-size: 55px;
      font-weight: 300;
      border-radius: 10px;)UI23"
#endif
R"UI24(      background-color: #4F4F4F;
    }
