...
DevicePanel::DevicePanel(SettingsWindow *parent) : ListWidget(parent) {
  ...
  setStyleSheet(
#ifdef RK_BUILD
R"UI0(    #reboot_btn { height: 44px; border-radius: 6px; background-color: #393939; })UI0"
#else
R"UI1(    #reboot_btn { height: 120px; border-radius: 15px; background-color: #393939; })UI1"
#endif
R"UI2(    #reboot_btn:pressed { background-color: #4a4a4a; })UI2"
#ifdef RK_BUILD
R"UI3(    #poweroff_btn { height: 44px; border-radius: 6px; background-color: #E22C2C; })UI3"
#else
R"UI4(    #poweroff_btn { height: 120px; border-radius: 15px; background-color: #E22C2C; })UI4"
#endif
R"UI5(    #poweroff_btn:pressed { background-color: #FF2424; }
  )UI5");
...
SettingsWindow::SettingsWindow(QWidget *parent) : QFrame(parent) {
  ...
  close_btn->setStyleSheet(R"UI6(
    QPushButton {)UI6"
#ifdef RK_BUILD
R"UI7(      font-size: 52px;
      padding-bottom: 8px;
      border-radius: 38px;)UI7"
#else
R"UI8(      font-size: 140px;
      padding-bottom: 20px;
      border-radius: 100px;)UI8"
#endif
R"UI9(      background-color: #292929;)UI9"
#ifdef RK_BUILD
R"UI10(      font-weight: 148;)UI10"
#else
R"UI11(      font-weight: 400;)UI11"
#endif
R"UI12(    }
    QPushButton:pressed {
  ...
  for (auto &[name, panel] : panels) {
    ...
    btn->setStyleSheet(R"UI13(
      QPushButton {
        color: grey;
        border: none;
        background: none;)UI13"
#ifdef RK_BUILD
R"UI14(        font-size: 24px;
        font-weight: 186;)UI14"
#else
R"UI15(        font-size: 65px;
        font-weight: 500;)UI15"
#endif
R"UI16(      }
      QPushButton:checked {
        color: white;
  ...
  setStyleSheet(R"UI17(
    * {
      color: white;)UI17"
#ifdef RK_BUILD
R"UI18(      font-size: 18px;)UI18"
#else
R"UI19(      font-size: 50px;)UI19"
#endif
R"UI20(    }
    SettingsWindow {
    ...
    QStackedWidget, ScrollView {
      background-color: #292929;)UI20"
#ifdef RK_BUILD
R"UI21(      border-radius: 12px;)UI21"
#else
R"UI22(      border-radius: 30px;)UI22"
#endif
R"UI23(    }
  )UI23");
#endif
