...
from openpilot.system.hardware import RK
...
# ponytail: FILLBACK set (current) stock 1928x1208/2648; absent reverts to committed RK 1280x720 webcam
FILLBACK = "FILLBACK" in os.environ
_ar_ox_fcam = CameraConfig(1280, 720, 900.0) if (RK and not FILLBACK) else CameraConfig(1928, 1208, 2648.0)
_ar_ox_config = DeviceCameraConfig(_ar_ox_fcam, _ar_ox_fisheye, _ar_ox_fisheye)
...
if FILLBACK:
  DEVICE_CAMERAS[("pc", "ox03c10")] = _ar_ox_config
